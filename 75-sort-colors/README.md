...
<pre data-cacher="true" data-cacher-block-id="1109162380"><strong>Input:</strong> nums = [2,0,2,1,1,0]
<strong>Output:</strong> [0,0,1,1,2,2]
</pre>

<p><strong>Example 2:</strong></p>

<pre data-cacher="true" data-cacher-block-id="210866678"><strong>Input:</strong> nums = [2,0,1]
