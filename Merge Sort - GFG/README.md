...
<pre data-cacher="true" data-cacher-block-id="192942076"><span style="font-size:18px"><strong>Input:</strong>
N = 5
arr[] = {4 1 3 9 7}</span>
...
<pre data-cacher="true" data-cacher-block-id="634302579" class=""><span style="font-size:18px"><strong>Input:</strong>
N = 10
